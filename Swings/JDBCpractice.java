...
public class JDBCpractice {
    ...
    JDBCpractice() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","JDBCpractice","<password>");
    ...
    public void createTable() {
        try {
            ps = con.prepareStatement("create table practiceStudent(roll_no integer, sname varchar2(25), marks number(5,3))");
            ps.execute();
    ...
    public void truncate() {
        try {
            ps = con.prepareStatement("truncate table practiceStudent");
            ps.execute();
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    public void dropTable() {
        try {
            st.execute("drop table practiceStudent");
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
